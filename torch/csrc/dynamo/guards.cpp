...
// public:
//   AttrGuardAccessor(py::str name, std::unique_ptr<GuardManager> guard_manager) : _attr_name(name) {}

//   bool is_accessor_of(py::object value) {
//     return True;
//   }

//   py::object access_guard(py::object value) {
//     return _guard;

//     if (py::hasattr(value, _attr_name)) {
//       return _guard;
//     } else {
//       _guard = GuardManager();

//       throw py::key_error(_attr_name);
//     }
//     return py::getattr(value, _attr_name);
//   }
// private:
//   py::str _attr_name;
// };
...
PyObject* torch_c_dynamo_guards_init() {
  ...
  py::class_<GuardManager, std::unique_ptr<GuardManager>>(py_m, "GuardManager")
    ...
    // .def("add_leaf_guard", &GuardManager::add_leaf_guard);
